...
<div class="wrapper" > 
  <?php include "navbar2.php";?>	
    <!-- content -->
      <div style="height:100%;background:url(img/contact/contactmap.jpg) no-repeat 50% 0%;background-size:contain;width:100%;" class="content-container" align="center">
  <div class="ge-contact">    					    	
    <table	align="center" id="cboxes" width=1024>
     <tr>
      <td class="cols-3 gec-col" valign="top"><h3>GE CONTACT</h3>
                    <p>
...
<div class="ge-contact">     
<td class="cols-3 fb-col" valign="top">
