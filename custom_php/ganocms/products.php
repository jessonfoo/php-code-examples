...
<div  id="cafeslide-1" align="center">
  ...
  <td>
     ...
     <a href="" id="ganoc"></a>
     <br>
     <span class="fogtext">Our retail brand of comfort beverages, from premium tasting wellness coffee and tea to silky enriched hot chocolate, each chockfull of 150+ antioxidants, 200+ phytonutrients and the power of Ganoderma lucidum.</span>
   </div>
  </td>
  <td>
     <div class="ganocafe">
     <a href="" id="ganod"></a>
     <br>
     <span class="fogtext">Our daily-use line of enriched products include personal care products such as toothpaste and soap, and are complimented by a wide range of legendary body balance supplements.</span>
   </div> 
  </td>
	    </tr>
	</table>    
...
<td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:15px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> GINSENG TONGKAT ALI</div>
    </div>    
    </div>
    </a>
    ...
    text-align:right;"><font color="#666666">GANOCAFÉ</font> HAZELNUT</div>
    </div>    
    </div>
    </a>
...
<td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> MOCHA</div>
    </div>    
    </div>
    </a>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> SCHOKOLADE</div>
    </div>    
    </div>
    </a>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> SPIRULINA</div>
    </div>    
    </div>
    </a>
</td>    
<td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> 3 IN 1</div>
    </div>    
    </div>
    </a>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> CLASSIC</div>
    </div>    
    </div>
    </a>
    ...
    text-align:right;"><font color="#666666">GANOCAFÉ</font> RED ROOIBOS TEA</div>
    </div>    
    </div>
    </a>
...
foreach ($pros as $pro)
{
    ...
    text-align:right;"><font color="#666666">GANOCAFÉ</font> <?php echo strtoupper($pro[title]);?></div>
    </div>    
    </div>
    </a>    
        <?php
...
<td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> SOAP</div>
    </div>    
    </div>
    </a>
</td>   
<td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> FRESH</div>
    </div>    
    </div>
    </a>
</td> 
...
<tr>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> CORDYCEPS</div>
    </div>    
    </div>
    </a> 
    </td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> GARCINIA</div>
    </div>    
    </div>
    </a>    
    </td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> SAKANNO</div>
    </div>    
    </div>
    </a>      
    </td>
...
<tr>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> EXCELLIUM</div>
    </div>    
    </div>
    </a> 
    </td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> GANODERMA</div>
    </div>    
    </div>
    </a>    
    </td>
    ...
    <div style="height:40px;background-color:black;color:white;vertical-align:middle;font-size:24px;padding:5px;
    text-align:right;"><font color="#666666">GANOCAFÉ</font> SAMPLE PACK</div>
    </div>    
    </div>
    </a>      
    </td>
