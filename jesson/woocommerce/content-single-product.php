...
<div itemscope itemtype="http://schema.org/Product" style="background-color:white;" id="product-<?php the_ID(); ?>" <?php post_class('single-product-page'); ?>>
	
	<div style="color:black;text-align:left;" class="row-fluid product-info sidebar-position-<?php echo $position; ?> responsive-sidebar-<?php echo $responsive; ?>">
		<?php
			/**
