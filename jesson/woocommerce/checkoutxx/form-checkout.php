	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<div class="checkout-steps">
            ...
            <div style="margin-left:0px !important;" class="span12 et-mega-search plr-30 mt-10 lh-1 upcase f-play d-ib" data-products="1" data-count="3" data-posts="1" data-portfolio="1" data-pages="1" data-images="1">
             <form method="get" action="http://192.185.175.151/~accutek/" class="p-rel ng-pristine ng-valid">
                <input style="height:30px;margin-bottom:0px;margin-top:0px;border-radius:4px;" type="text" class="bg-lgrey lh-1 br-8 f-play" value="" name="s" id="s" autocomplete="off" placeholder="Search By Part Number or Keyword">
                <input type="hidden" name="post_type" value="product"> 
                 <input type="submit" value="" style="width:40px;background:url(<?php get_img('arrow_white.png');?>) no-repeat 50% 50% #BC232C;margin-right:-40px;" class="p-abs button active filled">
 </style>
              </form>
